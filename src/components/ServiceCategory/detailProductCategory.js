...
import { DeleteProductCategory } from "../../redux/actions/servicesCategory/deleteProductCategoryAction";
import { loadSingleProductCategory } from "../../redux/actions/servicesCategory/detailProductCategoryAction";
import Loader from "../loader/loader";
import PageTitle from "../page-header/PageHeader";
import GenerateBarcodePopUp from "../Service/generateBarcodePopUp";
  ...
  const columns = [
    {
      ...
      dataIndex: "imageUrl",
      render: (imageUrl) => (
        <img style={{ maxWidth: "40px" }} alt="service" src={imageUrl} />
      ),
    },
    {
      title: "ID",
...
const DetailProductCategory = () => {
  ...
  const onDelete = () => {
    try {
      ...
      return navigate("/service-category");
    } catch (error) {
              ...
              >
                ...
                <div className="text-end w-50">
                  <Link
                    ...
                    to={`/service-category/${category.id}/update`}
                    state={{ data: category }}
                  >
                    <Button
                      type="primary"
