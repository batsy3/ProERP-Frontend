...
import { deleteProduct } from "../../redux/actions/Services/deleteProductAction";
import { loadSingleProduct } from "../../redux/actions/Services/detailProductAction";
...
const DetailsProd = () => {
  ...
  const service = useSelector((state) => state.products.service);
  ...
  const onDelete = () => {
    try {
      ...
      setVisible(false);
      toast.warning(`Product : ${service.name} is removed `);
