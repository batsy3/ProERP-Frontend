...
const AddPurch = () => {
  ...
  const allAccounts = useSelector((state) => state.accounts.list);
  ...
  const onFormSubmit = async (values) => {
    ...
    try {
      ...
      if (resp.message === "success") {
        ...
        setAfterDiscount(0);
        setLoader(false);
        navigate(`/Procurement/${resp.createdInvoiceId}`);
      } else {
        setLoader(false);
      }
    } catch (error) {
  ...
  const handleSelectedProds = (prodId, key) => {
    const foundProd = allAccounts.find((item) => item.id === prodId);
      ...
      >
        <Row className="mr-top" gutter={[24, 24]}>
          ...
          <Col span={24} lg={16}>
            ...
            <div className="d-flex justify-content-between mb-1">
              <Form.Item name="supplier_memo_no" label="Purchase Order No">
                <Input placeholder="Order no " onChange={updateFormData} />
              </Form.Item>
          ...
          <Col span={24} lg={8}>
            ...
            >
              <strong>Total: </strong>
              <strong>{totalDiscountPaidDue.total} Zmk</strong>
            </div>
            <div
              style={{
                padding: "10px 20px",
            ...
            >
              ...
              <strong>{totalDiscountPaidDue.afterDiscount} Zmk</strong>
            </div>
            <div
              style={{
                padding: "10px 20px",
            ...
            >
              ...
              <strong>{totalDiscountPaidDue.due} Zmk</strong>
            </div>
